...
class TestBackupRestore(unittest.TestCase):
    ...
    @patch("bedrock_server_manager.cli.backup_restore.backup_restore_api.prune_old_backups")
    ...
    @patch("bedrock_server_manager.cli.backup_restore.backup_restore_api.backup_config_file")
    @patch("bedrock_server_manager.cli.backup_restore.backup_restore_api.prune_old_backups")
    ...
    @patch("bedrock_server_manager.cli.backup_restore.backup_restore_api.restore_config_file")
