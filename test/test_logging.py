...
class TestLogging:
    def test_setup_logging(self, temp_log_dir):
        ...
        handlers = [h for h in logger.handlers if not type(h).__name__ == '_LiveLoggingNullHandler']
    ...
    def test_setup_logging_reconfigure(self, temp_log_dir):
        ...
        logger = setup_logging(log_dir=temp_log_dir, file_log_level=logging.DEBUG, cli_log_level=logging.ERROR, force_reconfigure=True)
    ...
    def test_setup_logging_dir_creation_error(self, mock_makedirs, capsys):
        ...
        logger = setup_logging(log_dir="/non/existent/dir", cli_log_level=logging.WARNING, force_reconfigure=True)
    ...
    def test_log_separator(self, temp_log_dir):
        ...
        logger = setup_logging(log_dir=temp_log_dir, log_filename="bedrock_server_manager.log", force_reconfigure=True)
